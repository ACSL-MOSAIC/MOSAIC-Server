...
export class Ros2ThumbstickToTwistStore extends SendableStore<Thumbstick> {
  static readonly connectorType = "ros2-thumbstick-to-twist"
  connectorType = Ros2ThumbstickToTwistStore.connectorType
