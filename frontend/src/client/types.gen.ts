...
export type DynamicTypeConfigReadDynamicTypeConfigResponse = (DynamicTypeConfigPublic);

export type DynamicTypeConfigUpsertDynamicTypeConfigData = {
    requestBody: DynamicTypeConfigCreate;
};

export type DynamicTypeConfigUpsertDynamicTypeConfigResponse = (DynamicTypeConfigPublic);

export type DynamicTypeConfigDeleteDynamicTypeConfigResponse = (Message);
