...
import { ApiError, CancelablePromise, type GlobalDto, OpenAPI, type OpenAPIConfig } from "@/client";
...
export const getResultCode = <T>(response: AxiosResponse<GlobalDto<T>>): number | null => {
