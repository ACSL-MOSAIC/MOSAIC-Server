...
import AngleIndicator from "@/widgets/ProgressivePointCloud2DViewerWidget/AngleIndicator.tsx";

export default function ProgressivePointCloud2DViewerWidget({ widgetConfig }: WidgetProps) {
