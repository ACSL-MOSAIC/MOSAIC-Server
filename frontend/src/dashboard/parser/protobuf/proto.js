...
export const chunking = $root.chunking = (() => {
    ...
    chunking.DataChunk = (function() {
        ...
        DataChunk.decode = function decode(reader, length, error) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.chunking.DataChunk();
        ...
        DataChunk.fromObject = function fromObject(object) {
            if (object instanceof $root.chunking.DataChunk)
                return object;
            let message = new $root.chunking.DataChunk();
...
export const pointcloud = $root.pointcloud = (() => {
    ...
    pointcloud.PointField = (function() {
        ...
        PointField.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pointcloud.PointField();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        PointField.fromObject = function fromObject(object) {
            if (object instanceof $root.pointcloud.PointField)
                return object;
            let message = new $root.pointcloud.PointField();
            if (object.name != null)
    ...
    pointcloud.PointCloud2 = (function() {
        ...
        PointCloud2.encode = function encode(message, writer) {
            ...
            if (message.header != null && Object.hasOwnProperty.call(message, "header"))
                $root.pointcloud.PointCloud2.Header.encode(message.header, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            ...
            if (message.fields != null && message.fields.length)
                for (let i = 0; i < message.fields.length; ++i)
                    $root.pointcloud.PointField.encode(message.fields[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.isBigendian != null && Object.hasOwnProperty.call(message, "isBigendian"))
                writer.uint32(/* id 5, wireType 0 =*/40).bool(message.isBigendian);
            if (message.pointStep != null && Object.hasOwnProperty.call(message, "pointStep"))
                writer.uint32(/* id 6, wireType 0 =*/48).uint32(message.pointStep);
            if (message.rowStep != null && Object.hasOwnProperty.call(message, "rowStep"))
                writer.uint32(/* id 7, wireType 0 =*/56).uint32(message.rowStep);
            if (message.data != null && Object.hasOwnProperty.call(message, "data"))
                writer.uint32(/* id 8, wireType 2 =*/66).bytes(message.data);
            if (message.isDense != null && Object.hasOwnProperty.call(message, "isDense"))
        ...
        PointCloud2.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pointcloud.PointCloud2();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.header = $root.pointcloud.PointCloud2.Header.decode(reader, reader.uint32());
                        break;
                    }
                case 2: {
                ...
                case 4: {
                        if (!(message.fields && message.fields.length))
                            message.fields = [];
                        message.fields.push($root.pointcloud.PointField.decode(reader, reader.uint32()));
                        break;
                    }
                case 5: {
        ...
        PointCloud2.verify = function verify(message) {
            ...
            if (message.header != null && message.hasOwnProperty("header")) {
                let error = $root.pointcloud.PointCloud2.Header.verify(message.header);
                if (error)
                    return "header." + error;
            }
            ...
            if (message.fields != null && message.hasOwnProperty("fields")) {
                ...
                for (let i = 0; i < message.fields.length; ++i) {
                    let error = $root.pointcloud.PointField.verify(message.fields[i]);
                    if (error)
                        return "fields." + error;
                }
            }
        ...
        PointCloud2.fromObject = function fromObject(object) {
            if (object instanceof $root.pointcloud.PointCloud2)
                return object;
            let message = new $root.pointcloud.PointCloud2();
            if (object.header != null) {
                if (typeof object.header !== "object")
                    throw TypeError(".pointcloud.PointCloud2.header: object expected");
                message.header = $root.pointcloud.PointCloud2.Header.fromObject(object.header);
            }
            ...
            if (object.fields) {
                ...
                for (let i = 0; i < object.fields.length; ++i) {
                    ...
                    message.fields[i] = $root.pointcloud.PointField.fromObject(object.fields[i]);
                }
            }
            if (object.isBigendian != null)
                message.isBigendian = Boolean(object.isBigendian);
            if (object.pointStep != null)
                message.pointStep = object.pointStep >>> 0;
            if (object.rowStep != null)
            ...
            if (object.isDense != null)
                message.isDense = Boolean(object.isDense);
            return message;
        };
        ...
        PointCloud2.toObject = function toObject(message, options) {
            ...
            if (message.header != null && message.hasOwnProperty("header"))
                object.header = $root.pointcloud.PointCloud2.Header.toObject(message.header, options);
            if (message.height != null && message.hasOwnProperty("height"))
            ...
            if (message.fields && message.fields.length) {
                ...
                for (let j = 0; j < message.fields.length; ++j)
                    object.fields[j] = $root.pointcloud.PointField.toObject(message.fields[j], options);
            }
            if (message.isBigendian != null && message.hasOwnProperty("isBigendian"))
        ...
        PointCloud2.Header = (function() {
            ...
            Header.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pointcloud.PointCloud2.Header();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            Header.fromObject = function fromObject(object) {
                if (object instanceof $root.pointcloud.PointCloud2.Header)
                    return object;
                let message = new $root.pointcloud.PointCloud2.Header();
                if (object.stamp != null)
                    message.stamp = Number(object.stamp);
            ...
            Header.toObject = function toObject(message, options) {
                ...
                if (message.stamp != null && message.hasOwnProperty("stamp"))
                    object.stamp = options.json && !isFinite(message.stamp) ? String(message.stamp) : message.stamp;
                if (message.frameId != null && message.hasOwnProperty("frameId"))
