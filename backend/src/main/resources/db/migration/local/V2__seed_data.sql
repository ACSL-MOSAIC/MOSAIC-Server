...
-- Insert sample users
INSERT INTO users (pk, organization_fk, is_active, is_organization_admin, email, full_name, hashed_password, created_at, updated_at)
VALUES
    ('00000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', TRUE, TRUE,
     'admin@example.com', 'Admin User', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', -- password: password
     CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000000001', TRUE, FALSE,
     'user@example.com', 'Regular User', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', -- password: password
     CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO dashboard (pk, organization_fk, created_at, updated_at)
VALUES ('00000000-0000-0000-0000-000000000030', '00000000-0000-0000-0000-000000000001',
        CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Insert sample tabs
INSERT INTO tab (pk, dashboard_fk, name, tab_config, created_at, updated_at)
VALUES
    ('00000000-0000-0000-0000-000000000040', '00000000-0000-0000-0000-000000000030',
     'Main Dashboard', '{"widgets": []}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('00000000-0000-0000-0000-000000000041', '00000000-0000-0000-0000-000000000030',
     'Monitoring', '{"widgets": []}', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
