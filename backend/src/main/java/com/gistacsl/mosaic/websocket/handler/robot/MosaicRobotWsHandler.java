  ...
  public Mono<Void> handleWsMessageRequest(WsMessage<?> wsMessage, RobotWsSession wsSession) {
    ...
    return switch (prefix) {
      ...
      case MosaicRobotAuthorizeHandler.TYPE_PREFIX ->
          this.mosaicRobotAuthorizeHandler
                    ...
                    .onErrorResume(
                        throwable -> {
                          if (throwable instanceof CustomException e) {
                            ...
                            WsMessage<ResultCode> newWsMessage =
                                new WsMessage<>(
                                    msg.getType() + ".res", ResultCode.UNKNOWN_EXCEPTION_OCCURRED);
                            this.handleError(
                                newWsMessage,
                                new CustomException(
        ...
        wsSession
                ...
                (webSocketMessage, synchronousSink) -> {
                  try {
                    ...
                    WsMessage<ResultCode> wsMessage =
                        new WsMessage<>("unknown.res", ResultCode.INVALID_FORMAT);
            ...
            .<WsMessage<?>>handle(
                (wsMessage, synchronousSink) -> {
                  if (!wsMessage.getType().equals(MosaicRobotAuthorizeHandler.TYPE_PREFIX)
                        ...
                        .onErrorResume(
                            throwable -> {
                              ...
                              if (throwable instanceof CustomException e) {
                                ...
                                WsMessage<ResultCode> newWsMessage =
                                    new WsMessage<>(
                                        wsMessage.getType() + ".res",
                                        ResultCode.UNKNOWN_EXCEPTION_OCCURRED);
                                this.handleError(
                                    newWsMessage,
                                    new CustomException(
                                        ResultCode.UNKNOWN_EXCEPTION_OCCURRED, throwable),
            ...
            .onErrorContinue(
                (e, o) -> {
                  ...
                  WsMessage<ResultCode> newWsMessage =
                      new WsMessage<>(
                          wsMessage.getType() + ".res", ResultCode.UNKNOWN_EXCEPTION_OCCURRED);
                  this.handleError(
                      newWsMessage,
