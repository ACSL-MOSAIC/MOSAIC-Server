...
public class OccupancyMapRepository {
   ...
   */
  public Mono<OccupancyMapEntity> findByPkAndOrganizationFk(
      UUID pk, UUID organizationFk, DSLContext dsl) {
    return Mono.from(
            dsl.select(
                    OCCUPANCY_MAP.PK,
   ...
   */
  public Flux<OccupancyMapEntity> findAllByOrganizationFk(
