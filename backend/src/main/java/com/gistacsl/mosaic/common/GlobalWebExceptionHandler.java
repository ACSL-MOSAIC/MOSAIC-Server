...
public class GlobalWebExceptionHandler implements ErrorWebExceptionHandler {
  ...
  public static final String DEFAULT_ERROR_BODY =
      "{\"resultCode\": " + ResultCode.UNKNOWN_EXCEPTION_OCCURRED.getValue() + "}";
  ...
  private String getResponseBody(Throwable ex) {
    if (ex instanceof ICustomException customException) {
      ...
      return this.getResponseBodyByCustomException(
          new CustomException(ResultCode.INVALID_FORMAT, serverWebInputException));
    } else {
